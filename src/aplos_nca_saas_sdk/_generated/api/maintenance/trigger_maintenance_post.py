...
from ...models.trigger_maintenance_post_body import TriggerMaintenancePostBody
from ...types import Response


def _get_kwargs(
    *,
    body: TriggerMaintenancePostBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v3/maintenance/trigger",
    }
...
def sync_detailed(
    *,
    ...
    """Maintenance: Manually trigger maintenance execution
