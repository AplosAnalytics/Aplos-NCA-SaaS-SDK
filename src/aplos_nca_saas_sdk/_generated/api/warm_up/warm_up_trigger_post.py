...
from ...models.warm_up_trigger_post_body import WarmUpTriggerPostBody
from ...types import Response


def _get_kwargs(
    *,
    body: WarmUpTriggerPostBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v3/admin/warm-up",
    }
...
def sync_detailed(
    *,
    ...
    """Lambda Warm-Up: On-demand API trigger for warm-up cycle
