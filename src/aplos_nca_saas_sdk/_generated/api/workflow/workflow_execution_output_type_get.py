...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v3/tenants/{tenant_id}/users/{user_id}/executions/{execution_id}/outputs/type/{output_type}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Analysis Workflow: Lists output files of a specific type (e.g. custom-plots, custom-tables) for an
    execution.
