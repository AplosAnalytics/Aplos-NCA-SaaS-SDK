...
from ...models.workflow_restore_post_body import WorkflowRestorePostBody
...
def _get_kwargs(
    ...
    execution_id: str,
    *,
    body: WorkflowRestorePostBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v3/tenants/{tenant_id}/users/{user_id}/executions/{execution_id}/restore".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Analysis Workflow: Restores an archived workflow.
