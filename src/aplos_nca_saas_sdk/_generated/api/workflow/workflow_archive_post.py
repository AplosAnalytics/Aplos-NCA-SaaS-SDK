...
from ...models.workflow_archive_post_body import WorkflowArchivePostBody
...
def _get_kwargs(
    ...
    execution_id: str,
    *,
    body: WorkflowArchivePostBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v3/tenants/{tenant_id}/users/{user_id}/executions/{execution_id}/archive".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Analysis Workflow: Archives a workflow.
