...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v3/tenants/{tenant_id}/users/{user_id}/executions/{execution_id}/diagnostics".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Execution Workflow: Diagnostics - retrieves the diagnostic event timeline for an execution tree.
