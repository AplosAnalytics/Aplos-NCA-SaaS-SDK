...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v3/tenants/{tenant_id}/users/{user_id}/executions/{execution_id}/outputs/{key_name}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Analysis Workflow: Gets a specific output file record for an execution by key name.
