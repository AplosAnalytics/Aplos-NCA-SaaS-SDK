...
if TYPE_CHECKING:
    ...
    from ..models.workflow_get_history_get_response_200_data import (
        WorkflowGetHistoryGetResponse200Data,
    )


T = TypeVar("T", bound="WorkflowGetHistoryGetResponse200")


@_attrs_define
class WorkflowGetHistoryGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (WorkflowGetHistoryGetResponse200Data | Unset): Operation payload (shape varies by endpoint).
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: WorkflowGetHistoryGetResponse200Data | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: WorkflowGetHistoryGetResponse200Data | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = WorkflowGetHistoryGetResponse200Data.from_dict(_data)
        ...
        workflow_get_history_get_response_200 = cls(
            success=success,
        ...
        workflow_get_history_get_response_200.additional_properties = d
        return workflow_get_history_get_response_200
