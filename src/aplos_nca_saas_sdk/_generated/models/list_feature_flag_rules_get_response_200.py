...
T = TypeVar("T", bound="ListFeatureFlagRulesGetResponse200")


@_attrs_define
class ListFeatureFlagRulesGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (list[FeatureFlagRule] | Unset): Operation payload (shape varies by endpoint).
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: list[FeatureFlagRule] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = FeatureFlagRule.from_dict(data_item_data)
        ...
        list_feature_flag_rules_get_response_200 = cls(
            success=success,
        ...
        list_feature_flag_rules_get_response_200.additional_properties = d
        return list_feature_flag_rules_get_response_200
