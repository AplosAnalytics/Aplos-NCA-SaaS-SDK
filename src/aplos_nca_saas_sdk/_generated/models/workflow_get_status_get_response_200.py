...
T = TypeVar("T", bound="WorkflowGetStatusGetResponse200")


@_attrs_define
class WorkflowGetStatusGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (Execution | Unset): An analysis execution summary. The same shape is returned by the status, root,
            history, and lineage endpoints (history/lineage return arrays of this). Fields are formatted by
            ExecutionSummaryFormatter.to_api_response.
        message (str | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: Execution | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = Execution.from_dict(_data)
        ...
        workflow_get_status_get_response_200 = cls(
            success=success,
        ...
        workflow_get_status_get_response_200.additional_properties = d
        return workflow_get_status_get_response_200
