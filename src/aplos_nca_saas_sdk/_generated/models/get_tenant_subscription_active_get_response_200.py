...
T = TypeVar("T", bound="GetTenantSubscriptionActiveGetResponse200")


@_attrs_define
class GetTenantSubscriptionActiveGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (Subscription | Unset): A tenant subscription (billing plan + limits). Aplos-specific limits (executions,
            profiles, seats, storage) are stored under `metadata`.
        message (str | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_tenant_subscription_active_get_response_200 = cls(
            success=success,
        ...
        get_tenant_subscription_active_get_response_200.additional_properties = d
        return get_tenant_subscription_active_get_response_200
