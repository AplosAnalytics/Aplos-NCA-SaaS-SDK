...
T = TypeVar("T", bound="ListTenantGetResponse200Data")


@_attrs_define
class ListTenantGetResponse200Data:
    """
    Attributes:
        ...
        tenants (list[Tenant] | Unset):
    """

    count: int
    next_key: None | str | Unset = UNSET
    tenants: list[Tenant] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        list_tenant_get_response_200_data = cls(
            count=count,
            next_key=next_key,
            tenants=tenants,
        )

        list_tenant_get_response_200_data.additional_properties = d
        return list_tenant_get_response_200_data
