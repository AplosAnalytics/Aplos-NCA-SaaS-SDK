...
if TYPE_CHECKING:
    from ..models.feature_flag_rule import FeatureFlagRule
...
T = TypeVar("T", bound="CreateFeatureFlagRulePostResponse201")


@_attrs_define
class CreateFeatureFlagRulePostResponse201:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (FeatureFlagRule | Unset): A feature-flag rule enabling/disabling a feature key for a given scope.
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: FeatureFlagRule | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: FeatureFlagRule | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = FeatureFlagRule.from_dict(_data)
        ...
        create_feature_flag_rule_post_response_201 = cls(
            success=success,
        ...
        create_feature_flag_rule_post_response_201.additional_properties = d
        return create_feature_flag_rule_post_response_201
