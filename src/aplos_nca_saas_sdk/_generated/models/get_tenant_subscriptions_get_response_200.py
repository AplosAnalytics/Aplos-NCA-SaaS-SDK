...
if TYPE_CHECKING:
    from ..models.get_tenant_subscriptions_get_response_200_data import (
...
T = TypeVar("T", bound="GetTenantSubscriptionsGetResponse200")


@_attrs_define
class GetTenantSubscriptionsGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (GetTenantSubscriptionsGetResponse200Data | Unset): Operation payload (shape varies by endpoint).
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: GetTenantSubscriptionsGetResponse200Data | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: GetTenantSubscriptionsGetResponse200Data | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = GetTenantSubscriptionsGetResponse200Data.from_dict(_data)
        ...
        get_tenant_subscriptions_get_response_200 = cls(
            success=success,
        ...
        get_tenant_subscriptions_get_response_200.additional_properties = d
        return get_tenant_subscriptions_get_response_200
