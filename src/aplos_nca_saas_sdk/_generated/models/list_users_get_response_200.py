...
if TYPE_CHECKING:
    from ..models.list_users_get_response_200_data import ListUsersGetResponse200Data
...
class ListUsersGetResponse200:
    ...
    Attributes:
        ...
        data (ListUsersGetResponse200Data | Unset): Operation payload (shape varies by endpoint).
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: ListUsersGetResponse200Data | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.list_users_get_response_200_data import (
        ...
        data: ListUsersGetResponse200Data | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = ListUsersGetResponse200Data.from_dict(_data)
