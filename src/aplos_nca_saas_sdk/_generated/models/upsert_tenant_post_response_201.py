...
T = TypeVar("T", bound="UpsertTenantPostResponse201")


@_attrs_define
class UpsertTenantPostResponse201:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (Tenant | Unset): A customer organization (tenant) in the multi-tenant platform.
        message (str | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        upsert_tenant_post_response_201 = cls(
            success=success,
        ...
        upsert_tenant_post_response_201.additional_properties = d
        return upsert_tenant_post_response_201
