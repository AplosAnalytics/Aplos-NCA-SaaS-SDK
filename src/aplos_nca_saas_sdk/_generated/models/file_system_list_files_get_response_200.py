...
if TYPE_CHECKING:
    from ..models.file_system_list_files_get_response_200_data import (
...
T = TypeVar("T", bound="FileSystemListFilesGetResponse200")


@_attrs_define
class FileSystemListFilesGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (FileSystemListFilesGetResponse200Data | Unset): Operation payload (shape varies by endpoint).
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: FileSystemListFilesGetResponse200Data | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: FileSystemListFilesGetResponse200Data | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = FileSystemListFilesGetResponse200Data.from_dict(_data)
        ...
        file_system_list_files_get_response_200 = cls(
            success=success,
        ...
        file_system_list_files_get_response_200.additional_properties = d
        return file_system_list_files_get_response_200
