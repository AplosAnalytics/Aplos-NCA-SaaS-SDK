...
T = TypeVar("T", bound="FileSystemListFilesGetResponse200Data")


@_attrs_define
class FileSystemListFilesGetResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        file_system_list_files_get_response_200_data = cls(
            count=count,
            next_key=next_key,
            files=files,
        )

        file_system_list_files_get_response_200_data.additional_properties = d
        return file_system_list_files_get_response_200_data
