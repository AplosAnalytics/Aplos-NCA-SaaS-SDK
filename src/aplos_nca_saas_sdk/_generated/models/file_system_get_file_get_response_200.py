...
T = TypeVar("T", bound="FileSystemGetFileGetResponse200")


@_attrs_define
class FileSystemGetFileGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (File | Unset): File metadata record (the file's bytes live in S3; this is metadata + references).
        message (str | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        file_system_get_file_get_response_200 = cls(
            success=success,
        ...
        file_system_get_file_get_response_200.additional_properties = d
        return file_system_get_file_get_response_200
