...
if TYPE_CHECKING:
    from ..models.queue_accepted_response import QueueAcceptedResponse
...
T = TypeVar("T", bound="AnalysisSendToQueuePostResponse201")


@_attrs_define
class AnalysisSendToQueuePostResponse201:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (QueueAcceptedResponse | Unset): Acknowledgement that an analysis was accepted onto the workflow queue.
            `status` is `queued` normally, or `throttled` when admission delayed it (with `delaySeconds`).
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: QueueAcceptedResponse | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: QueueAcceptedResponse | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = QueueAcceptedResponse.from_dict(_data)
        ...
        analysis_send_to_queue_post_response_201 = cls(
            success=success,
        ...
        analysis_send_to_queue_post_response_201.additional_properties = d
        return analysis_send_to_queue_post_response_201
