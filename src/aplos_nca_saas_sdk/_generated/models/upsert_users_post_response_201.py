...
T = TypeVar("T", bound="UpsertUsersPostResponse201")


@_attrs_define
class UpsertUsersPostResponse201:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (User | Unset): A user within a tenant.
        message (str | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        upsert_users_post_response_201 = cls(
            success=success,
        ...
        upsert_users_post_response_201.additional_properties = d
        return upsert_users_post_response_201
