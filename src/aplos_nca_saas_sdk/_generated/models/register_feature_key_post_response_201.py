...
T = TypeVar("T", bound="RegisterFeatureKeyPostResponse201")


@_attrs_define
class RegisterFeatureKeyPostResponse201:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (FeatureKeyRegistration | Unset): A registered feature key that rules can target.
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: FeatureKeyRegistration | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: FeatureKeyRegistration | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = FeatureKeyRegistration.from_dict(_data)
        ...
        register_feature_key_post_response_201 = cls(
            success=success,
        ...
        register_feature_key_post_response_201.additional_properties = d
        return register_feature_key_post_response_201
