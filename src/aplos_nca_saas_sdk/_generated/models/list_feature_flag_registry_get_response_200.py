...
if TYPE_CHECKING:
    from ..models.feature_key_registration import FeatureKeyRegistration
...
T = TypeVar("T", bound="ListFeatureFlagRegistryGetResponse200")


@_attrs_define
class ListFeatureFlagRegistryGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (list[FeatureKeyRegistration] | Unset): Operation payload (shape varies by endpoint).
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: list[FeatureKeyRegistration] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = FeatureKeyRegistration.from_dict(data_item_data)
        ...
        list_feature_flag_registry_get_response_200 = cls(
            success=success,
        ...
        list_feature_flag_registry_get_response_200.additional_properties = d
        return list_feature_flag_registry_get_response_200
