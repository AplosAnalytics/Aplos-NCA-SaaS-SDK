...
if TYPE_CHECKING:
    ...
    from ..models.template_list_get_response_200_data import (
        TemplateListGetResponse200Data,
    )


T = TypeVar("T", bound="TemplateListGetResponse200")


@_attrs_define
class TemplateListGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (TemplateListGetResponse200Data | Unset): Operation payload (shape varies by endpoint).
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: TemplateListGetResponse200Data | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: TemplateListGetResponse200Data | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = TemplateListGetResponse200Data.from_dict(_data)
        ...
        template_list_get_response_200 = cls(
            success=success,
        ...
        template_list_get_response_200.additional_properties = d
        return template_list_get_response_200
