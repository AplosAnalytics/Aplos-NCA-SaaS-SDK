...
if TYPE_CHECKING:
    from ..models.list_tenant_get_response_200_data import ListTenantGetResponse200Data
...
T = TypeVar("T", bound="ListTenantGetResponse200")


@_attrs_define
class ListTenantGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (ListTenantGetResponse200Data | Unset): Operation payload (shape varies by endpoint).
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: ListTenantGetResponse200Data | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.list_tenant_get_response_200_data import (
        ...
        data: ListTenantGetResponse200Data | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = ListTenantGetResponse200Data.from_dict(_data)
        ...
        list_tenant_get_response_200 = cls(
            success=success,
        ...
        list_tenant_get_response_200.additional_properties = d
        return list_tenant_get_response_200
