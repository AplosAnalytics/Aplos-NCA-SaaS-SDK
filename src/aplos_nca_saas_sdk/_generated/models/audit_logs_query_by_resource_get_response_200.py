...
if TYPE_CHECKING:
    from ..models.audit_logs_query_by_resource_get_response_200_data import (
...
T = TypeVar("T", bound="AuditLogsQueryByResourceGetResponse200")


@_attrs_define
class AuditLogsQueryByResourceGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (AuditLogsQueryByResourceGetResponse200Data | Unset): Operation payload (shape varies by endpoint).
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: AuditLogsQueryByResourceGetResponse200Data | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: AuditLogsQueryByResourceGetResponse200Data | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = AuditLogsQueryByResourceGetResponse200Data.from_dict(_data)
        ...
        audit_logs_query_by_resource_get_response_200 = cls(
            success=success,
        ...
        audit_logs_query_by_resource_get_response_200.additional_properties = d
        return audit_logs_query_by_resource_get_response_200
