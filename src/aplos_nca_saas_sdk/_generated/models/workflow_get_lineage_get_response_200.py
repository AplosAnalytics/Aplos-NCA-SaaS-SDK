...
if TYPE_CHECKING:
    ...
    from ..models.workflow_get_lineage_get_response_200_data import (
        WorkflowGetLineageGetResponse200Data,
    )


T = TypeVar("T", bound="WorkflowGetLineageGetResponse200")


@_attrs_define
class WorkflowGetLineageGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (WorkflowGetLineageGetResponse200Data | Unset): Operation payload (shape varies by endpoint).
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: WorkflowGetLineageGetResponse200Data | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: WorkflowGetLineageGetResponse200Data | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = WorkflowGetLineageGetResponse200Data.from_dict(_data)
        ...
        workflow_get_lineage_get_response_200 = cls(
            success=success,
        ...
        workflow_get_lineage_get_response_200.additional_properties = d
        return workflow_get_lineage_get_response_200
