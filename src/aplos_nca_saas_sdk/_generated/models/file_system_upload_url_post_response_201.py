...
if TYPE_CHECKING:
    from ..models.presigned_upload_response import PresignedUploadResponse
...
T = TypeVar("T", bound="FileSystemUploadUrlPostResponse201")


@_attrs_define
class FileSystemUploadUrlPostResponse201:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (PresignedUploadResponse | Unset): A presigned S3 upload target. POST the file to `url` with the given
            `fields` (S3 POST policy) or PUT to `url` depending on method.
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: PresignedUploadResponse | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: PresignedUploadResponse | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = PresignedUploadResponse.from_dict(_data)
        ...
        file_system_upload_url_post_response_201 = cls(
            success=success,
        ...
        file_system_upload_url_post_response_201.additional_properties = d
        return file_system_upload_url_post_response_201
