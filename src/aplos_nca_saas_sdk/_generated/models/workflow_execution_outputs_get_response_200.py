...
if TYPE_CHECKING:
    ...
    from ..models.workflow_execution_outputs_get_response_200_data import (
        WorkflowExecutionOutputsGetResponse200Data,
    )


T = TypeVar("T", bound="WorkflowExecutionOutputsGetResponse200")


@_attrs_define
class WorkflowExecutionOutputsGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (WorkflowExecutionOutputsGetResponse200Data | Unset): Operation payload (shape varies by endpoint).
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: WorkflowExecutionOutputsGetResponse200Data | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: WorkflowExecutionOutputsGetResponse200Data | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = WorkflowExecutionOutputsGetResponse200Data.from_dict(_data)
        ...
        workflow_execution_outputs_get_response_200 = cls(
            success=success,
        ...
        workflow_execution_outputs_get_response_200.additional_properties = d
        return workflow_execution_outputs_get_response_200
