...
T = TypeVar("T", bound="WorkflowGetLineageGetResponse200Data")


@_attrs_define
class WorkflowGetLineageGetResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        workflow_get_lineage_get_response_200_data = cls(
            count=count,
            next_key=next_key,
            executions=executions,
        )

        workflow_get_lineage_get_response_200_data.additional_properties = d
        return workflow_get_lineage_get_response_200_data
