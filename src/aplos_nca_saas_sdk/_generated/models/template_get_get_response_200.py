...
T = TypeVar("T", bound="TemplateGetGetResponse200")


@_attrs_define
class TemplateGetGetResponse200:
    """
    Attributes:
        success (bool):  Example: True.
        status_code (int):  Example: 200.
        timestamp (datetime.datetime):
        data (ReportTemplate | Unset): A custom report template owned by a tenant.
        message (str | Unset):
    ...
    status_code: int
    timestamp: datetime.datetime
    data: ReportTemplate | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        data: ReportTemplate | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = ReportTemplate.from_dict(_data)
        ...
        template_get_get_response_200 = cls(
            success=success,
        ...
        template_get_get_response_200.additional_properties = d
        return template_get_get_response_200
