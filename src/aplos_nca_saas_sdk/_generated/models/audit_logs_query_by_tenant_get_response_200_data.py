...
T = TypeVar("T", bound="AuditLogsQueryByTenantGetResponse200Data")


@_attrs_define
class AuditLogsQueryByTenantGetResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        audit_logs_query_by_tenant_get_response_200_data = cls(
            count=count,
            next_key=next_key,
            items=items,
        )

        audit_logs_query_by_tenant_get_response_200_data.additional_properties = d
        return audit_logs_query_by_tenant_get_response_200_data
